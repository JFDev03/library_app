...
const storage: StorageEngine = multer.diskStorage({
  destination: (_req: Request, _file: Express.Multer.File, cb: (error: Error | null, destination: string) => void) => {
    cb(null, "C:\\Users\\asjo\\source\\repos\\LibrarySytem\\assets\\upload"); // Use double backslashes
  ...
  filename: (_req: Request, file: Express.Multer.File, cb: (error: Error | null, filename: string) => void) => {
    ...
    let filePath = join("C:\\Users\\asjo\\source\\repos\\LibrarySytem\\assets\\upload", newFileName);
    ...
    while (existsSync(filePath)) {
      ...
      filePath = join("C:\\Users\\asjo\\source\\repos\\LibrarySytem\\assets\\upload", newFileName);
      counter++;
    }
